...
Technically specking, these 2 categories are not that particular distinct since the both problems require the system to be able to draw some conclusion based on the context and the answer could have a pretty high degree of freedom. In other words, our system should be able to evaluate the answer with flexible rules or standards. 

It may appear far-fatched at the frist glance to teach a system to evaluate this type of problems. It may indicate that we should probably reframe our issue and break it apart into smaller elements. Based on our research, we suggest that we can think of this type of issue as a particular type of QA problem; after the QA procedure, we also need to match and evaluate the answers generated by machine and the learner such that we can provide an adequate evaluation. 
...
In terms of knowledge or learning evaluation, the format could be diversed i.e. a lecture given by the learner or an short summary essay written by the learner. Regardless the form, we can always convert the content into a predictable text, graphic or audible format that model can process. 
