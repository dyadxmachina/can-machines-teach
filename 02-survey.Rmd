...
1. Some datasets used for QG prpblem:
...
2. Typical datasets used for VQA research: 


 * VQA dataset that consists of 2 subsets: real images and abstract scenes.
 
 
 * Compositional Language and Elementary Visual Reasoning (CLEVR) diagnostic dataset that focuses on reasoning.
 
 
 * Task Driven Image Understanding Challenge dataset (TDIUC); it contains images and annotations from MSCOCO and Visual genome. 
