...
\title{Teaching Machines - Deep Learning and Online Education}


\Author[1]{Fanli (Christian)}{Zheng}
\Author[1]{Haohan}{Wang}


\affil[1]{dyad x machina}

%% The [] brackets identify the author with the corresponding affiliation. 1, 2, 3, etc. should be inserted.



\runningtitle{RMarkdown Template for Copernicus}

\runningauthor{Nüst et al.}

\correspondence{Fanli (Christian)\ Zheng\ (thechristianramsey@gmail.com)}
...
\begin{abstract}
We are at a time in history where much of applied knowledge is no longer
just coming from large instutions but from the information we consume on
the internet. With million of high quality free to access lectures,
articles, and how-tos, one could imagine that their one's primary
education could be primarilyself studied in the online world. What would
this type of world look like? What machine learning advances would be
needed and how do we begin to approach such work? The advances in the
theory and practice of deep learning has enabled us to learn from
instructured information. Here, we present a framework for using deep
learning to begin to sweave together one's primary education using
generative models.
\end{abstract}
