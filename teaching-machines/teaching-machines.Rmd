...
affiliation:
  - code: 1
    address: dyad x machina
abstract: |
  We are at a time in history where the unstructured is much of an individual's applied knowledge is no longer just coming from large instutions but from the information we consume on the internet. Youtube alone has over 7 billion videos that are watched by over 30 million users a day, We now have free to access lectures, articles, and how-tos, that vary in quality and are widely available and are frequented by    one could imagine that their one's primary education could be primarilyself studied in the online world. What would this type of world look like? What machine learning advances would be needed and how do we begin to approach such work? The advances in the theory and practice of deep learning has enabled us to learn from instructured information. Here, we present a framework for using deep learning to begin to sweave together one's primary education using generative models.
