...
VQA aims to enable the machine to answer the answer automatically which could in turn automated the whole question generating and evaluation process. 

Before we dive deep into VQA, let's take a look at a useful mechanism that are wildly used in VQA task: Attention mechanism.
